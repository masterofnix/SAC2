...
int64 static GetBlockValue(int nHeight, int64 nFees) {
	...
	//make sure the reward is at least 1 SAC
	if(nSubsidy < COIN) {
		nSubsidy = COIN;
	}
...
static const int64 nTargetTimespan = 0.35 *24 * 60 * 60;	// Securealumnicoin: 0.35 day
...
void ThreadScriptCheck() {
    RenameThread("securealumnicoin-scriptch");
...
{
    // Securealumnicoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdf83d8ce31005c88ee7e27aaf802a96dd6042800300c35d3045fe013a105ac39");
    }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Securealumnicoin: increase each by adding 2 to securealumnicoin's value.
...
void GenerateSecurealumnicoins(bool fGenerate, CWallet* pwallet)
{
