...
#ifndef H_SECUREALUMNICOIN_SCRIPT
#define H_SECUREALUMNICOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CSecurealumnicoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Securealumnicoin always counted CHECKMULTISIGs
