...
{
    BOOST_CHECK(TestSplitHost("www.securealumnicoin.org", "www.securealumnicoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.securealumnicoin.org]", "www.securealumnicoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.securealumnicoin.org:80", "www.securealumnicoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.securealumnicoin.org]:80", "www.securealumnicoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:40331", "127.0.0.1", 40331));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:40331", "127.0.0.1", 40331));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:40331", "::ffff:127.0.0.1", 40331));
    BOOST_CHECK(TestSplitHost("[::]:40331", "::", 40331));
    BOOST_CHECK(TestSplitHost("::40331", "::40331", -1));
    BOOST_CHECK(TestSplitHost(":40331", "", 40331));
    BOOST_CHECK(TestSplitHost("[]:40331", "", 40331));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:40331", "127.0.0.1:40331"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:40331", "[::]:40331"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
